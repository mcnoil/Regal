...
//mirror() zapfen(6);
translate([ueberwindungshoehe,platz]) haken();
...
module haken()
{
    square([hakenbreite,hakenlaenge+hakenbreite]);
    translate([-hakentiefe,hakenlaenge])square([hakentiefe+hakenbreite,hakenbreite]);
    translate([0,-stufenbreite]) square([hakenbreite,stufenbreite]);
}
//haken();
//stufe();
